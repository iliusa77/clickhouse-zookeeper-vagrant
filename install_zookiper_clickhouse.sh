...
sudo bash -c "echo '192.168.56.10 clickhouse-shard-1' >> /etc/hosts"
sudo bash -c "echo '192.168.56.11 clickhouse-shard-2' >> /etc/hosts"
sudo bash -c "echo '192.168.56.12 clickhouse-shard-3' >> /etc/hosts"
...
#Service
server.0=clickhouse-shard-1:2888:3888
server.1=clickhouse-shard-2:2888:3888
server.2=clickhouse-shard-3:2888:3888
EOF"
